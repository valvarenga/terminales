...
<section class="container">
    ...
    <div class="row g-4">@forelse($municipios as $municipio)<div class="col-sm-6 col-lg-4 col-xl-3">
        <a href="{{ route('departamento.terminales', [$departamento, $municipio]) }}" class="destination-card">
            <img src="{{ asset($municipio->url_M) }}" alt="{{ $municipio->nombre }}">
